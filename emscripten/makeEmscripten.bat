...
set "OPT= -s WASM=0 -s ASSERTIONS=0 -s FORCE_FILESYSTEM=1 -Wcast-align -fno-strict-aliasing -s VERBOSE=0 -s SAFE_HEAP=0 -s DISABLE_EXCEPTION_CATCHING=0 -DHAVE_STDINT_H -DNO_DEBUG_LOGS -Wno-pointer-sign -I. -I.. -I../vio2sf/desmume/ -I../psflib -I../zlib  -Os -O3 "
